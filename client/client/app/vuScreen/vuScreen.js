...
angular.module('colorAdminApp')
    ...
    $stateProvider
        ...
        .state('app.reports.cabincrew', {
            url: '/cabinCrew',
            templateUrl: 'app/vuScreen/views/cabincrew.html',
            data: { pageTitle: 'CabinCrew Logs' },
            resolve: {
                service: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
        ...
        .state('app.reports.smshostreport', {
            url: '/smshostreport',
            templateUrl: 'app/vuScreen/views/smshostreport.html',
            data: { pageTitle: 'SmS Host Report' },
            resolve: {
                service: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
        ...
        .state('app.reports.smsleadreport', {
            url: '/smsleadreport',
            templateUrl: 'app/vuScreen/views/smsleadreport.html',
            data: { pageTitle: 'SmS Lead Report' },
            resolve: {
                service: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
        ...
        .state('app.reports.openform', {
            url: '/clubregistration',
            templateUrl: 'app/vuScreen/views/openform.html',
            data: { pageTitle: 'Openform Logs' },
            resolve: {
                service: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        serie: true,
